...
//  $Id$
// ----------------------------------------------------------------------
FlitChannel::FlitChannel(Module *parent, string const &name, long long int classes)
...
void FlitChannel::SetSource(Router const *const router, long long int port)
{
  _routerSource = router;
  _routerSourcePort = port;
}

void FlitChannel::SetSink(Router const *const router, long long int port)
{
  _routerSink = router;
